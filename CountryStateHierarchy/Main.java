...
public class Main {
    public static void main(String[] args) {
        City c1 = new City("Parner");
        City c2 = new City("Sangamaner");
        City c3 = new City("Akole");
        City c4 = new City("Shirdi");

        City c5 = new City("Wagholi");
        City c6 = new City("Hadapasar");
        City c7 = new City("Deccan");
        City c8 = new City("Baner");
        City c9 = new City("Shirure");
